...
public class DatanodeProtocolServerSideTranslatorPB implements
  ...
  @Override
  public DatanodeProtocolProtos.GetBlocksResponseProto getBlocksForDatanode(RpcController unused,
                                                                            DatanodeProtocolProtos.GetBlocksRequestProto request) throws ServiceException {
    ...
    try {
      blocks = impl.getBlocksForDatanode(dnInfo, request.getSize(),
          request.getMinBlockSize());
    } catch (IOException e) {
      throw new ServiceException(e);
    }
    return DatanodeProtocolProtos.GetBlocksResponseProto.newBuilder()
